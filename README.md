...
- LMOUSE - attack
- E - use lever
- R - reset level #Developer use only
...
lvl 3 theme mountains - timer, falling snow, wind

**The “Volcano” Set**

lvl 1 - falling lava, segment with just avoiding it

lvl 2 - running away from lava wall, endless runner like
...
“Fireplace Sound loop” ([https://opengameart.org/content/fireplace-sound-loop](https://opengameart.org/content/fireplace-sound-loop)) by PagDev CC-0
